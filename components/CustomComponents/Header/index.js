    ...
    return (
      <AppBar className={appBarClasses}>
        <Toolbar className={classes.container}>
          ...
          { //Render menu on Left side of bar
            (this.props.menuButton == 'left') ?  this.renderMenuIcon() : null
          }
          ...
          {
            //Render menu on Right side of bar
            (this.props.menuButton == 'right') ?  this.renderMenuIcon() : null
          }
